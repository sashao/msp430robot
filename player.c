...
void __attribute__((interrupt (TIMER0_A1_VECTOR))) timer_sound_isr() {
    /* Push the timer forward by one note cycle. */
    TACCR0 += current_note*100000;
...
void __attribute__((interrupt (TIMER0_A0_VECTOR))) timer_elapsed_isr() {
    switch (TAIV) {
        case 2: /* CCR1 */
            TACCR1 += 19166; /* 1 ms */
            ms_elapsed++;
